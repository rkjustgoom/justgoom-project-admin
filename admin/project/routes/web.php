...
Route::prefix('users')->name('front.users.')->middleware(['auth', 'front.user'])->group(function () {
    ...
    Route::get('/document-form', fn () => app(PageController::class)->userPage('document-form'))->name('document-form');
    Route::get('/documents', fn () => app(PageController::class)->userPage('documents'))->name('documents');
    ...
    Route::get('/service-add', fn () => app(PageController::class)->userPage('service-add'))->name('service-add');
    Route::get('/service-edit', fn () => app(PageController::class)->userPage('service-edit'))->name('service-edit');
