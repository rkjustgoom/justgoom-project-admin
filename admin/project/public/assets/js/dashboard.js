(function($) {
  ...
  $(function() {
    ...
    if ($("#customers-chart").length) {
      ...
      const customersChartCanvas = $("#customers-chart").get(0).getContext("2d");
      new Chart(customersChartCanvas, config);
    }
    ...
    if ($("#customers-chart-dark").length) {
      ...
      const customersChartCanvas = $("#customers-chart-dark").get(0).getContext("2d");
      new Chart(customersChartCanvas, config);
    }
    ...
    if ($("#comments-chart").length) {
      ...
      const commentChartCanvas = $("#comments-chart").get(0).getContext("2d");
      new Chart(commentChartCanvas, config);
    }
    ...
    if ($("#comments-chart-dark").length) {
      ...
      const commentChartCanvas = $("#comments-chart-dark").get(0).getContext("2d");
      new Chart(commentChartCanvas, config);
    }
    ...
    if ($("#total-sales-chart").length) {
      ...
      const totalSalesChartCanvas = $("#total-sales-chart").get(0).getContext("2d");
      new Chart(totalSalesChartCanvas, config);
    }
    ...
    if ($("#total-sales-chart-dark").length) {
      ...
      const totalSalesChartCanvas = $("#total-sales-chart-dark").get(0).getContext("2d");
      new Chart(totalSalesChartCanvas, config);
    }
    ...
    if ($("#orders-chart").length) {
      ...
      const ordersChartCanvas = $("#orders-chart").get(0).getContext("2d");
      new Chart(ordersChartCanvas, config);
    }
    ...
    if ($("#orders-chart-dark").length) {
      ...
      const ordersChartCanvas = $("#orders-chart-dark").get(0).getContext("2d");
      new Chart(ordersChartCanvas, config);
    }
    ...
    if ($('#sales-chart').length) {
      ...
      for (var i = 0; i < data.datasets.length; i++) {
        legendHtml += `<li><span class="color-circle me-2" style="border-color:${data.datasets[i].borderColor}"></span>${data.datasets[i].label}</li>`;
      }
      document.getElementById('sales-chart').innerHTML = `<ul>${legendHtml}</ul>`;
    ...
    if ($('#sales-chart-dark').length) {
      ...
      // var legendHtml = '';
      // for (var i = 0; i < data.datasets.length; i++) {
      //   legendHtml += `<li><span class="legend-dots" style="background-color:${data.datasets[i].backgroundColor}"></span>${data.datasets[i].label}</li>`;
      // }
      // document.getElementById('sales-chart').innerHTML = `<ul>${legendHtml}</ul>`;
